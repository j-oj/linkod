...
const ActionButton = ({ type = "home", scrollThreshold = 200 }) => {
  ...
  return (
    ...
    >
      <button
        onClick={handleClick}
        className="w-12 h-12 rounded-full bg-maroon border-1 border-white text-white hover:scale-110 shadow-md flex items-center justify-center transition duration-300 ease-in-out z-50"
      >
